...
docker exec -i solid_web_1 sh -c "cd /var/www/html ; drush -y si standard --db-url=mysql://drupal:password@192.168.99.100/drupal --site-name=Solid --account-name=admin --account-pass=admin"
